...
class Opinion:
    ...
    def __init__(self, opinion_id="", author="", recommendation="", stars=0.0, content="", pros={}, cons={}, vote_yes=0, vote_no=0, publish_date="", purchase_date=""):
